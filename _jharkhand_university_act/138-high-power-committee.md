---
layout: "act"
title: "High Power Committee"
act_part: "CHAPTER XIV: ESTABLISHMENT OF NEW UNIVERSITIES - Section 138"
order: 148
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/137-project-report/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/139-compliance-to-approval-of-state-government/' | relative_url }}">Next</a>
</nav>
