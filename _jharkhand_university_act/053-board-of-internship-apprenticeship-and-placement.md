---
layout: "act"
title: "Board of Internship, Apprenticeship and Placement"
act_part: "CHAPTER IV: AUTHORITIES OF THE UNIVERSITY - Section 53"
order: 63
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/052-board-of-human-resource-management/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/054-board-of-inclusive-education/' | relative_url }}">Next</a>
</nav>
