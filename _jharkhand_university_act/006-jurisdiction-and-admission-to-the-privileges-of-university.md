---
layout: "act"
title: "Jurisdiction and Admission to the Privileges of University"
act_part: "CHAPTER II: STATE UNIVERSITIES - Section 6"
order: 16
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/005-powers-and-duties-of-the-university/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/007-university-open-to-all/' | relative_url }}">Next</a>
</nav>
