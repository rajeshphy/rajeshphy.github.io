...
act_part: "CHAPTER V: COUNCIL, COMMITTEES AND CELLS - Section 76"
order: 86
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/075-library-cum-knowledge-resources-committee/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/077-students-union-and-student-council/' | relative_url }}">Next</a>
</nav>
