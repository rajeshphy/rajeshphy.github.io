---
layout: "act"
title: "University Open to All"
act_part: "CHAPTER II: STATE UNIVERSITIES - Section 7"
order: 17
...
<p class="act-line act-line-main"><span class="act-marker">(2)</span><span class="act-line-text">The University shall adopt the reservation policy of the State Government for appointment to different posts of teachers and non-teaching staff, considering University as a Unit, and for the purpose of admission of students in the constituent colleges, University departments or University institutions:</span></p>
<p class="act-line act-line-proviso"><span class="act-marker">Provided that,</span><span class="act-line-text">for Universities mentioned under Schedule-III, this provision shall be applicable, only for University Departments.</span></p>
  </div>
</article>

<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/006-jurisdiction-and-admission-to-the-privileges-of-university/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/008-power-of-the-state-government/' | relative_url }}">Next</a>
</nav>
