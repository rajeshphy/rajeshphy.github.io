---
layout: "act"
title: "Disqualification for Membership of Authority"
act_part: "CHAPTER IV: AUTHORITIES OF THE UNIVERSITY - Section 64"
order: 74
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/063-cessation-of-membership/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/065-ineligibility-for-second-consecutive-term/' | relative_url }}">Next</a>
</nav>
