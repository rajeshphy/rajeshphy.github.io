...
act_part: "CHAPTER XII: UNIVERSITY FUNDS, ACCOUNTS AND AUDIT - Section 124"
order: 134
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/123-university-rules/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/125-university-fund/' | relative_url }}">Next</a>
</nav>
