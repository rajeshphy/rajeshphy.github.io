---
layout: "act"
title: "Punishment for Non-Compliance"
act_part: "CHAPTER XV: JHARKHAND STATE UNIVERSITY SERVICE COMMISSION - Section 156"
order: 166
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/155-audit-and-report-of-commission/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/157-protection-for-action-taken-in-good-faith/' | relative_url }}">Next</a>
</nav>
