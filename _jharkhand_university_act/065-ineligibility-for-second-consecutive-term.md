---
layout: "act"
title: "Ineligibility for Second Consecutive Term"
act_part: "CHAPTER IV: AUTHORITIES OF THE UNIVERSITY - Section 65"
order: 75
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/064-disqualification-for-membership-of-authority/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/066-conclusiveness-of-decision-of-authority/' | relative_url }}">Next</a>
</nav>
