...
act_part: "CHAPTER III: OFFICERS OF THE UNIVERSITY - Section 20"
order: 30
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/019-dean-of-faculty/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/021-proctor/' | relative_url }}">Next</a>
</nav>
