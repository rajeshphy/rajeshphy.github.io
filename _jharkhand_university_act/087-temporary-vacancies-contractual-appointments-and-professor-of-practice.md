---
layout: "act"
title: "Temporary Vacancies, Contractual Appointments and Professor of Practice"
act_part: "CHAPTER VI: SELECTION, APPOINTMENT AND PROMOTION OF OFFICERS, TEACHING AND NON-TEACHING EMPLOYEES OF THE UNIVERSITY - Section 87"
order: 97
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/086-appointment-and-promotion-of-non-teaching-staff-of-the-university/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/088-creation-of-posts/' | relative_url }}">Next</a>
</nav>
