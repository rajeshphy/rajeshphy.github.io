...
act_part: "CHAPTER XII: UNIVERSITY FUNDS, ACCOUNTS AND AUDIT - Section 128"
order: 138
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/127-annual-accounts-and-audit/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/129-authorities-and-employees-responsible-for-damages/' | relative_url }}">Next</a>
</nav>
