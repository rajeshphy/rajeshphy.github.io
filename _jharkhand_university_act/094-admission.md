...
layout: "act"
title: "Admission"
act_part: "CHAPTER VII: ADMISSION, EXAMINATION, EVALUATION AND OTHER MATTERS RELATING TO STUDENTS - Section 94"
order: 104
source_pdf: "/assets/pdf/ref/acts/2026-Gazette-Jharkhand-University-Act.pdf"
chapter_title: "CHAPTER VII: ADMISSION, EXAMINATION, EVALUATION AND OTHER MATTERS RELATING TO STUDENTS"
section_number: "94"
---
...
<p class="act-line act-line-main"><span class="act-marker">(2)</span><span class="act-line-text">Further with regard to the maintenance of discipline, the authority concerned shall have the power to refuse admission to a student, except at the entry point of any academic programme.,</span></p>
  </div>
</article>

<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/093-action-against-unlawful-activities/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/095-disputes-relating-to-admission/' | relative_url }}">Next</a>
</nav>
