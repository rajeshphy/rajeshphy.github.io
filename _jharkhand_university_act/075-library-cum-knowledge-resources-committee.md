---
layout: "act"
title: "Library-Cum-Knowledge Resources Committee"
act_part: "CHAPTER V: COUNCIL, COMMITTEES AND CELLS - Section 75"
order: 85
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/074-internal-quality-assurance-cell/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/076-purchase-committee/' | relative_url }}">Next</a>
</nav>
