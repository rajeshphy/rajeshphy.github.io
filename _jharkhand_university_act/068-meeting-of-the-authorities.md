---
layout: "act"
title: "Meeting of the Authorities"
act_part: "CHAPTER IV: AUTHORITIES OF THE UNIVERSITY - Section 68"
order: 78
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/067-resignation-of-membership/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/069-casual-vacancy-and-standing-committee-to-fill-vacancies/' | relative_url }}">Next</a>
</nav>
