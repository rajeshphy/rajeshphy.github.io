---
layout: "act"
title: "Employees Grievance Redressal Tribunal"
act_part: "CHAPTER VIII: GRIEVANCES OF STUDENTS AND EMPLOYEE - Section 102"
order: 112
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/101-employees-grievance-redressal-committee/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/103-employees-right-of-appeal/' | relative_url }}">Next</a>
</nav>
