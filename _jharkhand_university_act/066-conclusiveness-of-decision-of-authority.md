---
layout: "act"
title: "Conclusiveness of Decision of Authority"
act_part: "CHAPTER IV: AUTHORITIES OF THE UNIVERSITY - Section 66"
order: 76
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/065-ineligibility-for-second-consecutive-term/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/067-resignation-of-membership/' | relative_url }}">Next</a>
</nav>
