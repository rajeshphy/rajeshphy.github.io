...
act_part: "CHAPTER V: COUNCIL, COMMITTEES AND CELLS - Section 80"
order: 90
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/079-fee-fixation-committee/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/081-internal-complaints-committee/' | relative_url }}">Next</a>
</nav>
