...
act_part: "CHAPTER III: OFFICERS OF THE UNIVERSITY - Section 29"
order: 39
...
<article class="act-document act-section-document">
 ...
 <p class="act-essence-box">Brief: This section defines the office of the Director, Sports and Physical Education. It covers appointment or selection, term and reporting arrangements where stated, and sets out the powers, duties, vacancy arrangements, temporary-charge provisions or accountability requirements attached to the office under the Act.</p>
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/028-director-student-affairs-and-director-nss/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/030-director-internal-quality-assurance-cell/' | relative_url }}">Next</a>
</nav>
