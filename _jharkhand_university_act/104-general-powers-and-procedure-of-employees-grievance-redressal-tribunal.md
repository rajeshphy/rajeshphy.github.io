---
layout: "act"
title: "General Powers and Procedure of Employees Grievance Redressal Tribunal and Committee"
act_part: "CHAPTER VIII: GRIEVANCES OF STUDENTS AND EMPLOYEE - Section 104"
order: 114
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/103-employees-right-of-appeal/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/105-powers-of-tribunal-to-give-appropriate-relief-and-directions/' | relative_url }}">Next</a>
</nav>
