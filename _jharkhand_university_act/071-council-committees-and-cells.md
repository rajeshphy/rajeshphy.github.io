---
layout: "act"
title: "Council, Committees and Cells"
act_part: "CHAPTER V: COUNCIL, COMMITTEES AND CELLS - Section 71"
order: 81
...
<nav class="act-page-nav" aria-label="Act page navigation">
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/070-proceedings-of-university-authorities-and-bodies-not-invalidated-to-va/' | relative_url }}">Previous</a>
 <a class="act-page-nav-link act-page-nav-toc" href="{{ '/jharkhand-state-universities-act-2026/' | relative_url }}">TOC</a>
 <a class="act-page-nav-link" href="{{ '/jharkhand-university-act/072-advisory-committee/' | relative_url }}">Next</a>
</nav>
