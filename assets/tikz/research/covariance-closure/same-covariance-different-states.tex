...
\begin{tikzpicture}[
  ...
  result/.style={rounded corners=5pt,draw=teal!45!black,fill=teal!7,
    line width=.8pt,inner xsep=13pt,inner ysep=9pt,align=center}
]
...
\fill[paper] (-5.35,-4.35) rectangle (5.35,3.55);

\fill[white,rounded corners=5pt] (-5.0,-1.35) rectangle (-.3,3.25);
\draw[black!13,rounded corners=5pt,line width=.6pt]
  (-5.0,-1.35) rectangle (-.3,3.25);
\fill[white,rounded corners=5pt] (.3,-1.35) rectangle (5.0,3.25);
\draw[black!13,rounded corners=5pt,line width=.6pt]
  (.3,-1.35) rectangle (5.0,3.25);

% Non-Gaussian first excited state
\begin{scope}[shift={(-2.65,1.0)}]
...
\draw[flow] (-2.65,-1.40) .. controls (-2.4,-1.88) and (-1.75,-2.05) ..
  (-1.25,-2.20);
\draw[flow] (2.65,-1.40) .. controls (2.4,-1.88) and (1.75,-2.05) ..
  (1.25,-2.20);
