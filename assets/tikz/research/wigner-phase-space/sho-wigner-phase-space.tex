...
\fill[paper] (-8.05,-3.05) rectangle (8.05,3.05);

% Panel backgrounds
\foreach \cx in {-5.25,0,5.25}{
  \fill[white,rounded corners=5pt] (\cx-2.35,-2.70) rectangle (\cx+2.35,2.70);
  \draw[black!12,rounded corners=5pt,line width=.6pt]
    (\cx-2.35,-2.70) rectangle (\cx+2.35,2.70);
}

% --------------------------------------------------------------------------
% (a) Ground-state Gaussian
% --------------------------------------------------------------------------
...
% --------------------------------------------------------------------------
% (b) First excited state: negative core, positive ring
% --------------------------------------------------------------------------
...
% --------------------------------------------------------------------------
% (c) Exact harmonic flow: displaced Gaussian rotates clockwise
% --------------------------------------------------------------------------
\begin{scope}[shift={(5.25,0)}]
  ...
  \node[note,anchor=west] at (.80,-1.45) {same packet,\\rotated in phase space};
  \node[note,anchor=east,text=black!50] at (-.57,1.39) {earlier position};
