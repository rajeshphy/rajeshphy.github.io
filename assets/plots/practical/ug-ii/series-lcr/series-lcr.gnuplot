...
set output "assets/images/practical/ug-ii/series-lcr/series-lcr-graph.png"
...
set arrow from 800,0 to 800,50 nohead ls 2
set label 1 "resonance" at 835,47 tc rgb "#3b3834"
plot "assets/plots/practical/ug-ii/series-lcr/series-lcr-data.dat" using 1:2 smooth csplines with lines ls 1, \
