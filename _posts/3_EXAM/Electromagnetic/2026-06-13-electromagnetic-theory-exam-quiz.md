...
ANSWER: A
NOTE: Maxwell's electrostatic Gauss law is $\nabla\cdot\mathbf E=\rho/\epsilon_0$.
---
...
D: zero
ANSWER: A
NOTE: Ampere's law gives $B=\mu_0 nI$ inside an ideal long solenoid.
---
...
D: $\nabla\cdot\mathbf E$
ANSWER: A
NOTE: Electromagnetic energy flux is $\mathbf S=\mathbf E\times\mathbf B/\mu_0$.
---
...
D: $\epsilon_0/\mu_0$
ANSWER: B
NOTE: Maxwell's equations give $c=1/\sqrt{\mu_0\epsilon_0}$.
---
...
ANSWER: C
NOTE: Free charges rearrange until the internal electrostatic field vanishes.
{% endcapture %}
