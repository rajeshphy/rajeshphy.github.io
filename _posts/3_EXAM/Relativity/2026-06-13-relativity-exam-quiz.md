...
D: $\gamma=v/c$
ANSWER: A
NOTE: Special relativity defines $\gamma=(1-v^2/c^2)^{-1/2}$.
---
...
D: $t^2+x^2/c^2$
ANSWER: B
NOTE: With the common sign convention, $s^2=c^2t^2-x^2$ is Lorentz invariant.
---
...
D: $E=mv$
ANSWER: A
NOTE: The invariant mass shell condition is $E^2=p^2c^2+m^2c^4$.
---
...
ANSWER: A
NOTE: Proper time is the time interval in the clock's rest frame, where the events occur at the same place.
---
...
D: $0$
ANSWER: B
NOTE: Length contraction gives $L=L_0/\gamma$ along the direction of motion.
{% endcapture %}
