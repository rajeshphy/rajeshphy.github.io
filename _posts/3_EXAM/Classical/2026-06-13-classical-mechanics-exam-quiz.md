...
D: $p^2/m+kx^2$
ANSWER: A
EXPLAIN: The total energy is kinetic plus potential: $H=p^2/(2m)+kx^2/2$.
---
...
ANSWER: C
EXPLAIN: If $\partial L/\partial q=0$, Lagrange's equation gives $d(\partial L/\partial \dot q)/dt=0$.
---
...
D: $V(r)/r^2$
ANSWER: B
EXPLAIN: Angular motion contributes the centrifugal term $L^2/(2mr^2)$.
---
...
ANSWER: C
EXPLAIN: A stable equilibrium is a local minimum of potential energy, so the second derivative is positive.
---
...
D: $qp$
ANSWER: B
EXPLAIN: By definition, $\{q,p\}=(\partial q/\partial q)(\partial p/\partial p)-0=1$.
{% endcapture %}
