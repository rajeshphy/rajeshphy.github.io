...
ANSWER: C
EXPLAIN: For an ideal gas internal energy depends only on temperature, which is constant in an isothermal process.
---
...
D: $T_h-T_c$
ANSWER: B
EXPLAIN: Carnot efficiency is $\eta=1-T_c/T_h$ with absolute temperatures.
---
...
D: $dU=TdV-PdS$
ANSWER: A
EXPLAIN: The first law for reversible changes gives $dU=TdS-PdV$.
---
...
D: $C_P/C_V=R$
ANSWER: A
EXPLAIN: Mayer's relation is $C_P-C_V=R$ for one mole of ideal gas.
---
...
ANSWER: C
EXPLAIN: The second law states that entropy of an isolated system increases or remains constant.
{% endcapture %}
