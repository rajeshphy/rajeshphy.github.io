...
D: $0$
ANSWER: A
EXPLAIN: Since $z^2+1=(z-i)(z+i)$, the residue at $z=i$ is $1/(z+i)|_{z=i}=1/(2i)$.
---
...
ANSWER: B
EXPLAIN: Integration by parts gives $\int f'e^{-ikx}dx=ik\tilde f(k)$ when boundary terms vanish.
---
...
D: $-1,3$
ANSWER: A
EXPLAIN: The characteristic equation is $(2-\lambda)^2-1=0$, hence $\lambda=1,3$.
---
...
D: $(2l+1)\delta_{lm}$
ANSWER: C
EXPLAIN: Legendre polynomials obey $\int_{-1}^{1}P_lP_m dx=2\delta_{lm}/(2l+1)$.
---
...
D: $a/(s^2+a^2)$
ANSWER: B
EXPLAIN: $\int_0^\infty e^{-(s+a)t}dt=1/(s+a)$ for $\operatorname{Re}(s+a)>0$.
{% endcapture %}
