...
D: $[x,p]=ip^2$
ANSWER: B
EXPLAIN: Canonical quantization gives $[x,p]=i\hbar$.
---
...
D: $\hbar\omega/2$
ANSWER: B
EXPLAIN: The levels are $E_n=n^2\pi^2\hbar^2/(2mL^2)$, so $n=1$ gives the answer.
---
...
D: $1$ only
ANSWER: B
EXPLAIN: For a given $l$, $m=-l,-l+1,\ldots,l$.
---
...
D: periodic
ANSWER: B
EXPLAIN: $e^{-x^2}$ is even and $x$ is odd, so their product is odd.
---
...
D: $\psi^2/2m$
ANSWER: B
EXPLAIN: Born's rule identifies $|\psi|^2$ as probability density.
{% endcapture %}
