...
tags:
  ...
  - quarks
  - eightfold-way
permalink: /msc/sem-iii/particle-quarks/
hidden: true
---

<img src="{{ '/assets/images/msc/sem-iii/Eightfoldway.jpeg' | relative_url }}" alt="Particle Classification" class="my-custom-class" style="max-width:100%; height:auto;">
...
<div style="text-align: center;">
    <img src="{{ '/assets/images/msc/sem-iii/Quark-composition.jpeg' | relative_url }}" alt="Particle Classification" class="my-custom-class" style="max-width:30%; height:auto;">
</div>
...
<div style="text-align: center;">
    <img src="{{ '/assets/images/msc/sem-iii/Quarks-table.jpeg' | relative_url }}" alt="Particle Classification" class="my-custom-class" style="max-width:100%; height:auto;">
</div>
