---
title: "PhD Supervision and the Publication System"
summary: "An explanatory account of supervision, research independence, authorship, peer review, publication pressure, assessment, and group responsibility."
description: "An awareness-oriented account of how PhD supervision interacts with authorship, journals, peer review, research quality, and assessment."
date: 2026-06-30 11:10:00 +0530
categories:
  - doc-knowledge
tags:
  - phd-supervision
  ...
  - research-integrity
  - mentoring
permalink: /phd-supervision-publication-system/
hidden: true
---
...
- understanding of the field and its literature;
- formulation of researchable questions;
- command of appropriate analytical or computational methods;
- ability to distinguish assumptions from results;
- critical evaluation of evidence;
- communication of a coherent argument;
- recognition of limitations and uncertainty; and
...
- a defined question;
- a result that answers or materially changes that question;
- an identifiable relation to existing literature;
- sufficient evidence or derivation;
- a bounded claim; and
- an audience for whom the result has meaning.
...
- Hermiticity and operator domains;
- normalization and probability conservation;
- boundary and initial conditions;
- symmetries and conservation laws;
- gauge dependence or invariance;
- limiting cases and known special solutions;
- perturbative order and approximation regime;
- regularization and renormalization conventions;
- numerical convergence and parameter sensitivity; and
- agreement between prose, equations, figures and code.
...
- the closest mathematical or physical result;
- differences in assumptions and definitions;
- which methods are standard and which are new;
- whether an apparent gap has already been resolved under different terminology;
- which claims are accepted, disputed or obsolete; and
- how the new result changes understanding.
...
- **honorary authorship**, where seniority substitutes for contribution;
- **ghost authorship**, where a qualifying contributor is omitted;
- **coercive authorship**, where authority is used to demand credit;
- **disputed order**, where expectations were never made explicit; and
- **restricted accountability**, where an author cannot explain or defend the work associated with their name.
...
Journal reputation can refer to several non-equivalent features: broad prestige, specialist authority, citation indicators, historical importance, editorial selectivity or visibility to a target readership. The [journal landscape module]({{ '/quantum-physics-journal-landscape/' | relative_url }}) describes these distinctions in detail.
...
- preference for numerous small papers over one coherent contribution;
- pursuit of journal labels before the research question is stable;
- citation practices aimed at metrics rather than scholarship;
- avoidance of negative or corrective results;
- honorary authorship used as institutional currency;
- excessive delay while pursuing prestige; and
- reluctance to correct an error because of reputational fear.
...
The [San Francisco Declaration on Research Assessment](https://sfdora.org/read/) argues against using journal-based metrics as substitutes for evaluating individual articles or researchers. The [Leiden Manifesto](https://www.nature.com/articles/520429a) similarly places quantitative indicators within qualitative, field-aware expert judgment.
...
- correctness and transparency of the analysis;
...
- ethical handling of authorship and criticism; and
- ability to recognize and correct error.
...
- **apprenticeship**, with close work under one experienced researcher;
- **committee supervision**, where several academics share oversight;
- **collaborative-group supervision**, where projects develop through frequent group interaction;
- **co-supervision across institutions**, often combining complementary expertise; and
- **large-collaboration supervision**, where local doctoral work is embedded in a broader consortium.
...
- formulate a meaningful problem rather than only execute an assigned calculation;
- explain why assumptions are physically or mathematically appropriate;
- locate the closest prior work;
- reproduce and test results;
- identify the natural scholarly audience;
- distinguish criticism of a manuscript from criticism of a person;
- revise a claim when evidence changes; and
...
- [ORCID guidance for researchers](https://support.orcid.org/hc/en-us/articles/360006897334-What-is-an-ORCID-iD-and-how-do-I-use-it)
