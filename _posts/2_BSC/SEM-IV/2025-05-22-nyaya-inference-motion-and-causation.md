---
title: "Nyāya Inference, Motion, and Physical Causation"
summary: "Nyāya means of knowledge and the Vaiśeṣika classification and causal analysis of motion."
date: 2025-05-22 09:00:00 +0530
categories:
  - bsc-iv
tags: [bsc, semester-iv, mj-5, indian-knowledge-system, nyaya, kanada, motion, causation]
permalink: /bsc/sem-iv/mj-5/nyaya-inference-motion-and-causation/
hidden: true
---
...
- **perception (*pratyakṣa*):** cognition arising through an appropriate sense-object relation;
- **inference (*anumāna*):** knowledge of an unobserved fact from a reliable sign;
- **comparison (*upamāna*):** learning a referent through a known similarity;
- **testimony (*śabda*):** a competent speaker's trustworthy statement.
...
$$
\text{upward motion},\quad \text{downward motion},\quad
\text{contraction},\quad \text{expansion},\quad
\text{general locomotion}.
$$
...
- an **inherent or material cause (*samavāyi-kāraṇa*)**, such as threads of a cloth;
- a **non-inherent cause (*asamavāyi-kāraṇa*)**, such as the conjunction of those threads or a quality inherited through them; and
- an **efficient cause (*nimitta-kāraṇa*)**, such as the weaving operation.
